/******/ (function(modules) {
	 ...
	 */
                ...
                if (
                    typeof Set !== 'undefined' &&
                        Set.toString().match(/native code/)
                ) {
                    ...
                    if (!commonTagRE.test(tag) && !reservedTagRE.test(tag)) {
                        if (resolveAsset(options, 'components', tag)) {
                            ...
                            if (is) {
                                ...
                                var expectedTag = options._componentNameMap &&
                ...
                function guardComponents(options) {
                    if (options.components) {
                        ...
                        for (var i = 0, l = ids.length; i < l; i++) {
                            var key = ids[i];
                            if (
                                commonTagRE.test(key) || reservedTagRE.test(key)
                            ) {
                                'development' !== 'production' &&
                                    warn(
                    ...
                    if (isArray(assets)) {
                        ...
                        while (i--) {
                            ...
                            var id = typeof asset === 'function'
                                ? asset.options && asset.options.name ||
                                      asset.id
                                : asset.name || asset.id;
                            if (!id) {
                                'development' !== 'production' &&
                ...
                function mergeOptions(parent, child, vm) {
                    ...
                    if (true) {
                        if (child.propsData && !vm) {
                            warn(
                                'propsData can only be used as an instantiation option.'
                            );
                        }
                    }
                    var options = {};
                    ...
                    for (var i = 0, l = path.length; i < l; i++) {
                        ...
                        if (i < l - 1) {
                            ...
                            if (isArray(obj)) {
                                ...
                                if (
                                    'development' !== 'production' && obj._isVue
                                ) {
	 ...
	 */
                ...
                Watcher.prototype.teardown = function() {
                    if (this.active) {
                        ...
                        if (
                            !this.vm._isBeingDestroyed && !this.vm._vForRemoving
                        ) {
	 ...
	 */
                function FragmentFactory(vm, el) {
                    ...
                    if (
                        isString || isTemplate(el) && !el.hasAttribute('v-if')
                    ) {
	 ...
	 */
                ...
                FragmentFactory.prototype.create = function(
                    host,
                    scope,
                    parentFrag
                ) {
                ...
                var vFor = {
                    ...
                    bind: function bind() {
                        ...
                        var inMatch = this.expression.match(
                            /(.*) (?:in|of) (.*)/
                        );
                        if (inMatch) {
	   ...
	   */
                    ...
                    diff: function diff(data) {
                        ...
                        var item = data[0];
                        var convertedFromObject = this.fromObject = isObject(
                            item
                        ) &&
                            hasOwn(item, '$key') &&
                            hasOwn(item, '$value');
	   ...
	   */
                    ...
                    insert: function insert(frag, index, prevEl, inDocument) {
                        ...
                        if (inDocument && staggerAmount) {
                            ...
                            if (!anchor) {
                                anchor = frag.staggerAnchor = createAnchor(
                                    'stagger-anchor'
                                );
	   ...
	   */
                    ...
                    getStagger: function getStagger(frag, index, total, type) {
                        ...
                        return hook
                            ...
                            : index *
                                  parseInt(
                                      this.params[type] || this.params.stagger,
                                      10
                                  );
                    },
                    /**
	 ...
	 */
                ...
                var select = {
                    bind: function bind() {
                        ...
                        var multiple = this.multiple = el.hasAttribute(
                            'multiple'
                        );
	   ...
	   */
                ...
                var on$1 = {
                    ...
                    bind: function bind() {
                        // deal with iframes
                        if (
                            this.el.tagName === 'IFRAME' && this.arg !== 'load'
                        ) {
                            var self = this;
                    ...
                    update: function update(handler) {
                        ...
                        // key filter
                        var keys = Object.keys(this.modifiers).filter(function(
                            key
                        ) {
                            return key !== 'stop' &&
                                key !== 'prevent' &&
	   ...
	   */
                    ...
                    resolveComponent: function resolveComponent(value, cb) {
                        ...
                        this.pendingComponentCb = cancellable(function(
                            ...
                            self.ComponentName = Component.options.name ||
	 ...
	 */
                ...
                function compileProps(el, propOptions, vm) {
                    ...
                    while (i--) {
                        ...
                        if (
                            'development' !== 'production' && name === '$data'
                        ) {
                        ...
                        if ((value = getBindAttr(el, attr)) === null) {
                            if (
                                (value = getBindAttr(el, attr + '.sync')) !==
                                    null
                            ) {
                                prop.mode = propBindingModes.TWO_WAY;
                            } else if (
                                (value = getBindAttr(el, attr + '.once')) !==
                                    null
                            ) {
                        ...
                        if (value !== null) {
                            ...
                            value = /[A-Z\-]/.test(name) &&
                                (el.getAttribute(lowerCaseName) ||
                                    el.getAttribute(':' + lowerCaseName) ||
                                    el.getAttribute(
                                        'v-bind:' + lowerCaseName
                                    ) ||
                                    el.getAttribute(
                                        ':' + lowerCaseName + '.once'
                                    ) ||
                                    el.getAttribute(
                                        'v-bind:' + lowerCaseName + '.once'
                                    ) ||
                                    el.getAttribute(
                                        ':' + lowerCaseName + '.sync'
                                    ) ||
	 ...
	 */
                ...
                function processPropValue(vm, prop, rawValue, fn) {
                    var isSimple = prop.dynamic &&
                        isSimplePath(prop.parentPath);
                    var value = rawValue;
                    if (value === undefined) {
	 ...
	 */
                function Transition(el, id, hooks, vm) {
                    this.id = id;
                    this.el = el;
                    this.enterClass = hooks && hooks.enterClass ||
                        id + '-enter';
                    this.leaveClass = hooks && hooks.leaveClass ||
                        id + '-leave';
                    this.hooks = hooks;
                    this.vm = vm;
                    // async state
	 ...
	 */
                ...
                p$1.getCssTransitionType = function(className) {
                    ...
                    if (transDuration && transDuration !== '0s') {
                        ...
                        var animDuration = inlineStyles[animDurationProp] ||
	 ...
	 */
	   ...
	   */
                    ...
                    return function compositeLinkFn(vm, el, host, scope, frag) {
                        ...
                        // link
                        var dirs = linkAndCapture(
                            function compositeLinkCapturer() {
                                if (nodeLinkFn)
	 ...
	 */
                ...
                function compileRoot(el, options, contextOptions) {
                    ...
                    if (el.nodeType !== 11) {
                        ...
                        'development' !== 'production' && containerAttrs
                    ) {
	 ...
	 */
                ...
                function makeTerminalNodeLinkFn(
                    ...
                    var fn = function terminalNodeLinkFn(
                        vm,
                        el,
                        host,
                        scope,
	 ...
	 */
	   ...
	   */
                    ...
                    function pushDir(dirName, def, interpTokens) {
                        var hasOneTimeToken = interpTokens &&
                            hasOneTime(interpTokens);
	 ...
	 */
                ...
                function mergeAttrs(from, to) {
                    ...
                    while (i--) {
                        ...
                        value = attrs[i].value;
                        if (
                            !to.hasAttribute(name) && !specialCharRE.test(name)
                        ) {
                ...
                function resolveSlots(vm, content) {
                    ...
                    for (var i = 0, l = content.children.length; i < l; i++) {
                        ...
                        if (
                            ...
                            warn(
                                'The "slot" attribute must be static.',
                                vm.$parent
                            );
                        }
                    }
                    for (name in contents) {
                        contents[name] = extractFragment(
                            contents[name],
                            content
                        );
                    }
                    if (content.hasChildNodes()) {
                        ...
                        contents['default'] = extractFragment(
                            content.childNodes,
                            content
                        );
                    }
                    ...
                    function registerComponentEvents(vm, el) {
                        ...
                        for (var i = 0, l = attrs.length; i < l; i++) {
                            ...
                            if (eventRE.test(name)) {
                                ...
                                handler = (vm._scope || vm._context).$eval(
                                    value,
                                    true
                                );
	 ...
	 */
                ...
                Directive.prototype._setupParamWatcher = function(
                    key,
                    expression
                ) {
                    var self = this;
                    var called = false;
                    var unwatch = (this._scope ||
                        this.vm).$watch(
                        expression,
                        function(val, oldVal) {
                            self.params[key] = val;
                            ...
                            if (called) {
                                var cb = self.paramWatchers &&
                                    self.paramWatchers[key];
                                if (cb) {
                    ...
                    (this._paramUnwatchFns ||
                        (this._paramUnwatchFns = [])).push(unwatch);
                };
	 ...
	 */
	   ...
	   */
                    ...
                    Vue.prototype._compile = function(el) {
                        ...
                        if (
                            el.nodeType === 1 && getAttr(el, 'v-pre') !== null
                        ) {
                            return;
                        }
                        ...
                        if (options._linkerCachable) {
                            ...
                            if (!contentLinkFn) {
                                contentLinkFn = ctor.linker = compile(
                                    el,
                                    options
                                );
                            }
	   ...
	   */
                    ...
                    Vue.prototype._destroy = function(remove, deferCleanup) {
                        ...
                        var cleanupIfPossible = function cleanupIfPossible() {
                            if (
                                destroyReady && !pendingRemoval && !deferCleanup
                            ) {
                                self._cleanup();
                            }
                        };
	   ...
	   */
                    ...
                    Vue.prototype.$appendTo = function(
                        target,
                        cb,
                        withTransition
                    ) {
	   ...
	   */
                    ...
                    Vue.prototype.$prependTo = function(
                        target,
                        cb,
                        withTransition
                    ) {
	   ...
	   */
                    ...
                    Vue.prototype.$broadcast = function(event) {
                        ...
                        for (var i = 0, l = children.length; i < l; i++) {
                            ...
                            var shouldPropagate = child.$emit.apply(
                                child,
                                args
                            );
                            if (shouldPropagate) {
	   ...
	   */
                    ...
                    function modifyListenerCount(vm, event, count) {
                        ...
                        while (parent) {
                            parent._eventsCount[event] = (parent._eventsCount[
                                event
                            ] ||
                                0) +
                                count;
	 ...
	 */
                ...
                var slot = {
                    ...
                    bind: function bind() {
                        ...
                        var content = this.vm._slotContents &&
                            this.vm._slotContents[name];
                    ...
                    compile: function compile(content, context, host) {
                        if (content && context) {
                            if (
                                ...
                                var elseBlock = document.createElement(
                                    'template'
                                );
	 ...
	 */
                ...
                function contains(val, search) {
                    ...
                    if (isPlainObject(val)) {
                        ...
                        return val.toString().toLowerCase().indexOf(search) >
                            -1;
                    }
                }
        ...
        /***/ function(module, exports) {
            ...
            function generateMatch(startingPath, matcher, delegate) {
                return function(path, nestedCallback) {
                    ...
                    if (nestedCallback) {
                        nestedCallback(
                            generateMatch(fullPath, matcher, delegate)
                        );
                    } else {
                        return new Target(
                            startingPath + path,
            ...
            State.prototype = {
                get: function get(charSpec) {
                    ...
                    for (var i = 0, l = nextStates.length; i < l; i++) {
                        ...
                        var isEqual = child.charSpec.validChars ===
                            charSpec.validChars;
                        isEqual = isEqual &&
	 ...
	 */
            ...
            var HTML5History = (function() {
                ...
                HTML5History.prototype.formatPath = function formatPath(
                    path,
                    append
                ) {
            ...
            var HashHistory = (function() {
                ...
                HashHistory.prototype.start = function start() {
                    ...
                    this.listener = function() {
                        ...
                        var query = location.search && path.indexOf('?') > -1
                            ? '&' + location.search.slice(1)
                            : location.search;
                        self.onChange(
                            decodeURI(path.replace(/^#!?/, '') + query)
                        );
                    };
                ...
                HashHistory.prototype.formatPath = function formatPath(
                    path,
                    append
                ) {
            ...
            var AbstractHistory = (function() {
                ...
                AbstractHistory.prototype.go = function go(
                    path,
                    replace,
                    append
                ) {
                ...
                AbstractHistory.prototype.formatPath = function formatPath(
                    path,
                    append
                ) {
                    return path.charAt(0) === '/'
	 ...
	 */
            ...
            function activate(view, transition, depth, cb, reuse) {
                ...
                reuse = reuse &&
                    view.childVM &&
                    view.childVM.constructor === Component;
                ...
                if (reuse) {
                    ...
                    if (view.keepAlive) {
                        ...
                        if (cachedViews) {
                            transition.router._views = cachedViews.concat(
                                transition.router._views
                            );
                            view.childView = cachedViews[
                                cachedViews.length - 1
                            ];
	 ...
	 */
	   ...
	   */
                ...
                RouteTransition.prototype.abort = function abort() {
                    if (!this.aborted) {
                        ...
                        var abortingOnLoad = !this.from.path &&
                            this.to.path === '/';
                        if (!abortingOnLoad) {
                    ...
                    transition.runQueue(daq, canDeactivate, function() {
                        transition.runQueue(aq, canActivate, function() {
                            transition.runQueue(daq, deactivate, function() {
                                ...
                                transition.router._onTransitionValidated(
                                    transition
                                );

                                // trigger reuse for all reused views
                                reuseQueue &&
                                    reuseQueue.forEach(function(view) {
	   ...
	   */
                ...
                RouteTransition.prototype.runQueue = function runQueue(
                    queue,
                    fn,
                    cb
                ) {
	   ...
	   */
                ...
                RouteTransition.prototype.callHook = function callHook(
                    hook,
                    context,
                    cb
                ) {
                    var _ref = arguments.length <= 3 ||
                        arguments[3] === undefined
                        ? {}
                        : arguments[3];

                    var _ref$expectBoolean = _ref.expectBoolean;
                    var expectBoolean = _ref$expectBoolean === undefined
                        ? false
                        : _ref$expectBoolean;
                    var _ref$expectData = _ref.expectData;
                    var expectData = _ref$expectData === undefined
                        ? false
                        : _ref$expectData;
                    ...
                    if (expectBoolean) {
                        ...
                        expectData && isPlainOjbect(res) || !hook.length
                    ) {
                        next(res);
                    }
                };
	   ...
	   */
                ...
                RouteTransition.prototype.callHooks = function callHooks(
                    hooks,
                    context,
                    cb,
                    options
	 ...
	 */
            ...
            var Router = (function() {
                function Router() {
                    var _ref = arguments.length <= 0 ||
                        arguments[0] === undefined
                        ? {}
                        : arguments[0];

                    var _ref$hashbang = _ref.hashbang;
                    var hashbang = _ref$hashbang === undefined
                        ? true
                        : _ref$hashbang;
                    var _ref$abstract = _ref.abstract;
                    var abstract = _ref$abstract === undefined
                        ? false
                        : _ref$abstract;
                    var _ref$history = _ref.history;
                    var history = _ref$history === undefined
                        ? false
                        : _ref$history;
                    var _ref$saveScrollPosition = _ref.saveScrollPosition;
                    var saveScrollPosition = _ref$saveScrollPosition ===
                        undefined
                        ? false
                        : _ref$saveScrollPosition;
                    var _ref$transitionOnLoad = _ref.transitionOnLoad;
                    var transitionOnLoad = _ref$transitionOnLoad === undefined
                        ? false
                        : _ref$transitionOnLoad;
                    var _ref$suppressTransitionError = _ref.suppressTransitionError;
                    var suppressTransitionError = _ref$suppressTransitionError ===
                        undefined
                        ? false
                        : _ref$suppressTransitionError;
                    var _ref$root = _ref.root;
                    var root = _ref$root === undefined ? null : _ref$root;
                    var _ref$linkActiveClass = _ref.linkActiveClass;
                    var linkActiveClass = _ref$linkActiveClass === undefined
                        ? 'v-link-active'
                        : _ref$linkActiveClass;
	   ...
	   */
                ...
                Router.prototype.start = function start(App, container, cb) {
                    ...
                    if (!this.app) {
                        ...
                        var Ctor = this._appConstructor = typeof App ===
                            'function'
                            ? App
                            : Vue.extend(App);
	  ...
	  */
                ...
                Router.prototype._addRoute = function _addRoute(
                    path,
                    handler,
                    segments
                ) {
                    ...
                    handler.path = path;
                    handler.fullPath = (segments.reduce(
	   ...
	   */
                ...
                Router.prototype._addRedirect = function _addRedirect(
                    path,
                    redirectPath
                ) {
                    if (path === '*') {
	   ...
	   */
                ...
                Router.prototype._addAlias = function _addAlias(
                    path,
                    aliasPath
                ) {
	   ...
	   */
                ...
                Router.prototype._addGuard = function _addGuard(
                    path,
                    mappedPath,
                    _handler
                ) {
	   ...
	   */
                ...
                Router.prototype._match = function _match(path, state, anchor) {
                    ...
                    var transition = new RouteTransition(
                        this,
                        route,
                        currentRoute
                    );
	   ...
	   */
                ...
                Router.prototype._onTransitionValidated = function _onTransitionValidated(
                    transition
                ) {
                    // set current route
	   ...
	   */
                ...
                Router.prototype._postTransition = function _postTransition(
                    route,
                    state,
                    anchor
                ) {
	   ...
	   */
                ...
                Router.prototype._stringifyPath = function _stringifyPath(
                    path
                ) {
                    if (path && typeof path === 'object') {
                        if (path.name) {
                            ...
                            if (path.query) {
                                var query = this._recognizer.generateQueryString(
                                    path.query
                                );
	 ...
	 */
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var _revue = __webpack_require__(11);
            ...
            var _chords = __webpack_require__(23);

            var chordActions = _interopRequireWildcard(_chords);
            ...
            var reduxStore = createStoreWithMiddleware(_index2.default);

            var store = new _revue2.default(
                _vue2.default,
                reduxStore,
                _extends({}, chordActions)
            );
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            function parseProp(prop) {
                ...
                if (re.test(prop)) {
                    ...
                    var _prop$match2 = babelHelpers.slicedToArray(
                        _prop$match,
                        3
                    );
	 ...
	 */
                ...
                babelHelpers.createClass(Revue, [
                    {
                        ...
                        value: function dispatch() {
                            ...
                            return (_store = this.store).dispatch.apply(
                                _store,
                                arguments
                            );
                        }
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var _utilsIsPlainObject2 = _interopRequireDefault(
                _utilsIsPlainObject
            );
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            function getUnexpectedStateKeyWarningMessage(
                ...
                var argumentName = action &&
                    action.type === _createStore.ActionTypes.INIT
                ...
                if (!_utilsIsPlainObject2['default'](inputState)) {
                    return 'The ' +
                        ...
                        ({}).toString.call(inputState).match(/\s([a-z|A-Z]+)/)[
                            1
                        ] +
	 ...
	 */
            ...
            function combineReducers(reducers) {
                var finalReducers = _utilsPick2['default'](reducers, function(
                    val
                ) {
                ...
                var defaultState = _utilsMapValues2[
                    'default'
                ](finalReducers, function() {
                    return undefined;
                });
                ...
                return function combination(state, action) {
                    ...
                    var finalState = _utilsMapValues2[
                        'default'
                    ](finalReducers, function(reducer, key) {
	 ...
	 */
            ...
            function bindActionCreators(actionCreators, dispatch) {
                ...
                return _utilsMapValues2['default'](actionCreators, function(
                    actionCreator
                ) {
	 ...
	 */
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var _chords = __webpack_require__(22);
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var CHORD_LIBRARY = [
                ...
                },
                {
                    ...
                    chord: [
                        null,
                        { finger: 1, fret: 4, string: 1 },
                        { finger: 1, fret: 4, string: 2 },
                        { finger: 1, fret: 4, string: 3 },
                        { finger: 1, fret: 4, string: 4 }
                    ]
                },
                {
                    name: 'E',
        ...
        /***/ function(module, exports) {
            ...
            exports.sampleLoading = sampleLoading;
            var CHORD_LOADING = exports.CHORD_LOADING = 'CHORD_LOADING';
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            if (false) {
                ...
                if (!content.locals) {
                    module.hot.accept(
                        '!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-3a8eba91&file=main.vue!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./main.vue',
                        function() {
	...
	*/
            ...
            function insertStyleElement(options, styleElement) {
                ...
                var lastStyleElementInsertedAtTop = styleElementsInsertedAtTop[
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var _chordConfiguration = __webpack_require__(32);

            var _chordConfiguration2 = _interopRequireDefault(
                _chordConfiguration
            );
            ...
            // <template>
            //   <button v-on:click="addChord">+</button>
            //   <div v-for="id in chordProgresson" class="chord-block">
            //     <button v-on:click="removeChord(id)">-</button>
            //     <chord-configuration></chord-configuration>
            //   </div>
            // </template>
            ...
            exports.default = {
                ...
                components: {
                    chordConfiguration: _chordConfiguration2.default
                },
                methods: {
                    addChord: function addChord() {
                        console.log(this.chordProgresson);
                        this.chordProgresson = this.chordProgresson.concat(
                            Math.random().toString()
                        );
                    },
                    removeChord: function removeChord(id) {
                        this.chordProgresson = this.chordProgresson.filter(
                            function(singleId) {
                                return singleId !== id;
                            }
                        );
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var _chord = __webpack_require__(34);
            ...
            //     <option v-for="option in chords" v-bind:value="option.name">
            //       {{ option.name }}
            //     </option>
            //   </select>
            //   <chord :chord="selectedChord"></chord>
            // </template>
            ...
            exports.default = {
                data: function data() {
                    return {
                        selected: '',
                        chords: this.$select('chords')
                    };
                },
                computed: {
                    selectedChord: function selectedChord() {
                        var _this = this;

                        if (this.selected === '') {
                            return {};
                        }
                        return this.chords.find(function(singleChord) {
                            return singleChord.name === _this.selected;
                        });
                    }
                },
                components: {
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            if (false) {
                ...
                if (!content.locals) {
                    module.hot.accept(
                        '!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-6451e38c&file=chord.vue!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./chord.vue',
                        function() {
                            var newContent = require(
                                '!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-6451e38c&file=chord.vue!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./chord.vue'
                            );
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var _chordLine = __webpack_require__(38);

            var _chordLine2 = _interopRequireDefault(_chordLine);
            ...
            //   <h2>{{chord.name}}</h2>
            //   <table class="tab">
            //       <tbody v-for="item in loop" >
            //         <tr is="chord-line" :fret="item" :chord="returnFingers(item)"></tr>
            //       </tbody>
            //   </table>
            // </template>
            ...
            exports.default = {
                ...
                methods: {
                    returnFingers: function returnFingers(fret) {
                        return this.chord.chord
                            ? this.chord.chord.filter(function(singleChord) {
                                  return singleChord &&
                                      singleChord.fret === fret;
                              })
                            : [];
                    }
                }
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            exports.default = {
                ...
                ready: function ready() {},
                methods: {
                    noteCompute: function noteCompute(fret, string) {
                        return this.chord &&
                            this.chord.find(function(singleString) {
                                return singleString.string == string;
                            });
                    },
                    noteComputeDot: function noteComputeDot(string) {
                        return this.chord.find(function(singleFret) {
                            return singleFret.string == string;
                        }).finger;
                    }
                },
                props: {
            ...
            // </script>
            // <template>
            //     <td class="row">{{fret}}</td>
            //     <td v-for="string in loop">
            //       <div class="note" v-if="noteCompute(fret, string)">{{noteComputeDot(string)}}</div>
            //     </td>
            // </template>
            // <script>
            /***/
        ...
        /* 40 */
        /***/ function(module, exports) {
            module.exports = '<td class="row">{{fret}}</td>\n    <td v-for="string in loop">\n      <div class="note" v-if="noteCompute(fret, string)">{{noteComputeDot(string)}}</div>\n    </td>';
            /***/
        },
        /* 41 */
        /***/ function(module, exports) {
            module.exports = '<h2>{{chord.name}}</h2>\n  <table class="tab">\n      <tbody v-for="item in loop" >\n        <tr is="chord-line" :fret="item" :chord="returnFingers(item)"></tr>\n      </tbody>\n  </table>';
            /***/
        },
        /* 42 */
        /***/ function(module, exports) {
            module.exports = '<select v-model="selected">\n    <option v-for="option in chords" v-bind:value="option.name">\n      {{ option.name }}\n    </option>\n  </select>\n  <chord :chord="selectedChord"></chord>';
            /***/
        },
        /* 43 */
        /***/ function(module, exports) {
            module.exports = '<button v-on:click="addChord">+</button>\n  <div v-for="id in chordProgresson" class="chord-block">\n    <button v-on:click="removeChord(id)">-</button>\n    <chord-configuration></chord-configuration>\n  </div>';
            /***/
        },
        /* 44 */
        /***/ function(module, exports) {
