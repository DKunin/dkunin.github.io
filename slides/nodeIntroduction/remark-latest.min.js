...
})(
    {
        ...
        nZr0zp: [
            function(require, module, exports) {
                ...
                PrintComponent.prototype.setPageOrientation = function(
                    orientation
                ) {
                    ...
                    styler.setPageSize(
                        this._pageWidth + 'px ' + this._pageHeight + 'px'
                    );
                };
        ...
        aIW4aw: [
            function(require, module, exports) {
                ...
                function getSlideNo(slide, slideshow) {
                    ...
                    for (
                        i = 0;
                        i <= slide.getSlideIndex() && i < slides.length;
                        ++i
                    ) {
                    ...
                    EventEmitter.prototype.addListener = function(
                        ...
                        if (!this._events[type]) {
                            ...
                            if (!this._events[type].warned) {
                                ...
                                if (
                                    m && m > 0 && this._events[type].length > m
                                ) {
        ...
        t5Lx4S: [
            function(require, module, exports) {
                ...
                function getPageRule(stylesheet) {
                    ...
                    for (i = 0; i < l; ++i) {
                        if (
                            stylesheet.cssRules[i] instanceof window.CSSPageRule
                        ) {
        ...
        5: [
            function(require, module, exports) {
                exports.apply = function() {
                    forEach(
                        [Array, window.NodeList, window.HTMLCollection],
                        extend
                    );
                };
                        ...
                        function mergeStreams(original, highlighted, value) {
                            ...
                            function selectStream() {
                                ...
                                if (
                                    ...
                                    return original[0].offset <
                                        highlighted[0].offset
                                        ? original
                                        : highlighted;
                                }
                        ...
                        function highlight(
                            ...
                            function subMode(lexeme, mode) {
                                for (var i = 0; i < mode.contains.length; i++) {
                                    if (
                                        testRe(mode.contains[i].beginRe, lexeme)
                                    ) {
                            ...
                            function isIllegal(lexeme, mode) {
                                return !ignore_illegals &&
                                    testRe(mode.illegalRe, lexeme);
                            }
                            ...
                            function keywordMatch(mode, match) {
                                var match_str = language.case_insensitive
                                    ? match[0].toLowerCase()
                                    : match[0];
                                return mode.keywords.hasOwnProperty(
                                    match_str
                                ) &&
                            ...
                            function processKeywords() {
                                ...
                                while (match) {
                                    ...
                                    var keyword_match = keywordMatch(
                                        top,
                                        match
                                    );
                                    if (keyword_match) {
                        ...
                        languages = [
                            ...
                            },
                            {
                                ...
                                create: function(hljs) {
                                    ...
                                    var RUBY_KEYWORDS = 'and false then defined module in return redo if BEGIN retry end for true self when ' +
                            ...
                            },
                            {
                                name: 'cs',
                                create: function(hljs) {
                                    var KEYWORDS = 'abstract as base bool break byte case catch char checked const continue decimal ' +
        ...
        8: [
            function(require, module, exports) {
                ...
                exports.hasClass = function(element, className) {
                    return exports.getClasses(element).indexOf(className) !==
                        -1;
                };
            ...
            function(require, module, exports) {
                ...
                Api.prototype.convert = function(markdown) {
                    var parser = new Parser(),
                        content = parser.parse(markdown || '', macros)[
                            0
                        ].content;
                ...
                !(function() {
                    ...
                    Parser.prototype.parse = function(src, macros) {
                        ...
                        tokens.forEach(function(token) {
                            switch (token.type) {
                                ...
                                case 'separator':
                                    ...
                                    stack[
                                        0
                                    ].properties.continued = (token.text ===
                                        '--').toString();
                                    break;
                        ...
                        return slides.filter(function(slide) {
                            var exclude = (slide.properties.exclude ||
                                '').toLowerCase();
                            if (exclude === 'true') {
                                return false;
                            }
            ...
            function(require, module, exports) {
                ...
                function SlideshowView(
                    ...
                    events.on('toggleBlackout', function() {
                        utils.toggleClass(
                            self.containerElement,
                            'remark-blackout-mode'
                        );
                    });
                    events.on('toggleMirrored', function() {
                        utils.toggleClass(
                            self.containerElement,
                            'remark-mirrored-mode'
                        );
                    });
                ...
                function handleFullscreen(self) {
                    ...
                    self.events.on('toggleFullscreen', function() {
                        var fullscreenElement = utils.getPrefixedProperty(
                            document,
                            'fullscreenElement'
                        ) ||
                            utils.getPrefixedProperty(
                                document,
                                'fullScreenElement'
                            );
                ...
                SlideshowView.prototype.configureContainerElement = function(
                    element
                ) {
                    var self = this;
                ...
                SlideshowView.prototype.configureChildElements = function() {
                    ...
                    function onPrint(e) {
                        ...
                        self.slideViews.forEach(function(slideView) {
                            ...
                            // if (e.isPortrait) {
                            //     slideView.scalingElement.style.top = 0;
                            //     slideView.notesElement.style.top = 0 + "px"
                            // }
                        });
                    }
                };
                SlideshowView.prototype.updateSlideViews = function() {
                    var self = this;
                    self.slideViews.forEach(function(slideView) {
                        self.elementArea.removeChild(
                            slideView.containerElement
                        );
                    });
                    self.slideViews = self.slideshow
                        .getSlides()
                        .map(function(slide) {
        ...
        14: [
            function(require, module, exports) {
                ...
                function Slideshow(events, options) {
                    ...
                    self.getHighlightStyle = getOrDefault(
                        'highlightStyle',
                        'default'
                    );
                    self.getHighlightLanguage = getOrDefault(
                        'highlightLanguage',
                        ''
                    );
                ...
                function createSlides(slideshowSource, options) {
                    ...
                    parsedSlides.forEach(function(slide, i) {
                        ...
                        if (slide.properties.continued === 'true' && i > 0) {
                            ...
                            layoutSlide && slide.properties.layout !== 'true'
                        ) {
                    ...
                    if (options.scroll !== false) {
                        var scrollHandler = function(event) {
                            if (event.wheelDeltaY > 0 || event.detail < 0) {
                                ...
                                event.wheelDeltaY < 0 || event.detail > 0
                            ) {
                                events.emit('gotoNextSlide');
                            }
                        };
                ...
                function Navigation(events) {
                    ...
                    function gotoSlideByIndex(slideIndex, noMessage) {
                        var alreadyOnSlide = slideIndex === currentSlideIndex,
                            slideOutOfRange = slideIndex < 0 ||
                                slideIndex > self.getSlideCount() - 1;
            ...
            function(require, module, exports) {
                ...
                function inheritProperties(slide, template) {
                    ...
                    for (property in template.properties) {
                        ...
                        if (
                            property === 'class' && slide.properties[property]
                        ) {
                ...
                function inheritContent(slide, template) {
                    ...
                    if (expandedVariables.content === undefined) {
                        slide.content = slide.content.concat(
        ...
        19: [
            function(require, module, exports) {
                ...
                function getDimensions(ratio) {
                    return {
                        width: Math.floor(
                            referenceWidth / referenceRatio * ratio.ratio
                        ),
            ...
            function(require, module, exports) {
                ...
                function addMessageEventListeners(events) {
                    ...
                    function navigateByMessage(message) {
                        var cap;
                        if (
                            (cap = /^gotoSlide:(\d+)$/.exec(message.data)) !==
                                null
                        ) {
                            events.emit(
                                'gotoSlide',
            ...
            function(require, module, exports) {
                ...
                function addLocationEventListeners(events, dom, slideshowView) {
                    ...
                    function navigateByHash() {
                        var slideNoOrName = (dom.getLocationHash() ||
                            '').substr(1);
        ...
        18: [
            function(require, module, exports) {
                ...
                NotesView.prototype.configureElements = function() {
                    ...
                    self.notesElement.addEventListener('mousewheel', function(
                        event
                    ) {
                        event.stopPropagation();
                    });
                    self.notesPreviewElement.addEventListener(
                        'mousewheel',
                        function(event) {
                            event.stopPropagation();
                        }
                    ...
                    var commands = {
                        increase: function() {
                            self.notesElement.style.fontSize = (parseFloat(
        ...
        17: [
            function(require, module, exports) {
                ...
                SlideView.prototype.updateDimensions = function() {
                    ...
                    self.scalingElement.style.width = x + 'px';
                    self.scalingElement.style.height = y + 'px';
                };
                        ...
                        image.onload = function() {
                            if (
                                ...
                                if (!self.originalBackgroundSize) {
                                    ...
                                    self.contentElement.style.backgroundSize = image.width *
                                        scale +
                                        'px ' +
                                        image.height * scale +
                                        'px';
                ...
                function styleContentElement(slideshow, element, properties) {
                    ...
                    setHighlightStyleFromProperties(
                        element,
                        properties,
                        slideshow
                    );
                ...
                function wrapLines(block) {
                    var lines = block.innerHTML
                        .split(/\r?\n/)
                        .map(function(line) {
                            return '<div class="remark-code-line">' +
                                line +
                                '</div>';
                        });
                    if (
                        lines.length &&
                            lines[lines.length - 1].indexOf('><') !== -1
                    ) {
                        lines.pop();
                    }
        ...
        9: [
            function(require, module, exports) {
                ...
                converter.convertMarkdown = function(content, links, inline) {
                    element.innerHTML = convertMarkdown(
                        content,
                        links || {},
                        inline
                    );
                    ...
                    !(function() {
                        ...
                        Lexer.prototype.token = function(src, top) {
                            ...
                            while (src) {
                                ...
                                if (
                                    top && (cap = this.rules.nptable.exec(src))
                                ) {
                                    src = src.substring(cap[0].length);
                                    item = {
                                        type: 'table',
